...
int main(void)
{
	...
	char *sql = 	"DROP TABLE IF EXISTS Becarios;"
		    	"CREATE TABLE Becarios(id int, name TEXT, promedio int);"
		    	"INSERT INTO Becarios VALUES(1, 'Jorge', 9);"
			"INSERT INTO Becarios VALUES(2, 'Diana', 9);"
			"INSERT INTO Becarios VALUES(3, 'Fernando', 9);"
			"INSERT INTO Becarios VALUES(4, 'Tovar', 8);"; //accede a la base a traves del punto para insertar
